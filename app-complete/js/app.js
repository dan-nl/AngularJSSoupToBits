(function(){
  ...
  angular.module( 'readingList', [] )
	...
	.directive( 'reviewForm', function() {
		return {
			restrict: 'E',
			templateUrl: 'partials/review-form/form.html',
			controller: function() {
	...
	.directive( 'livePreview', function() {
		return {
			restrict: 'E',
			templateUrl: 'partials/review-form/live-preview.html'
		};
	})

	.directive( 'reviewFields', function() {
		return {
			restrict: 'E',
			templateUrl: 'partials/review-form/review-fields.html'
		};
	})
  ...
  var books = [
    {
      ...
      rating: 4,
      genres: { 'non-fiction': true, fantasy: false }
    },{
